...
begin
	...
	with all_inputs select W1 <=
		'1' when "100001" | -- Rock beat scissors
					"010100" | -- Paper beat rock
					"001010",  -- Scissors beat paper
		'0' when others;

	-- Using a "conditional signal assignment", aka "when/else"
	W2 <=
		'1' when all_inputs = "001100" else -- Rock beat scissors
		'1' when all_inputs = "010001" else -- Paper beat rock
		'1' when all_inputs = "100010" else -- Scissors beat paper
		'0';
	
	-- Using when/else in a different way
	E1 <=
		'1' when ((R1 = '1' and P1 = '1') or
					(R1 = '1' and S1 = '1') or
					(P1 = '1' and S1 = '1')) else
		'0';
	
	-- Using Boolean expression
	E2 <= (R2 and P2) or (R2 and S2) or (P2 and S2);
